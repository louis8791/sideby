...
- 本機已實作：完整 34 選項需求傳遞、全池資格篩選、版本場地發布／索引、個人場地負面回饋排序、離線候選去識別／審核／撤回。80 tests 與兩端 build 通過。
- 待完成：正式 migration／雙端部署／Runtime；補齊政府候選營業、價格、區域與主觀觀察證據；人工同意語料及保留題實測。1,121 候選不能一次冒充核准，三條改進管線不等於新模型已訓練。
